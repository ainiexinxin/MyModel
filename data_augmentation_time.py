...
class Insert(object):
    ...
    def __call__(self, item_sequence, time_diffs):
        ...
        for index, item in enumerate(copied_sequence):
            ...
            if index in insert_idx:
                ...
                if self.ensemble:
                    ...
                    inserted_sequence += self.item_similarity_model.get_item_similarest_map(item)
        ...
        for index in substitute_idx:
            if self.ensemble:
                ...
                copied_sequence[index] = copied_sequence[index] = \
                    self.item_similarity_model.get_item_similarest_map(copied_sequence[index])[0]
        return copied_sequence
