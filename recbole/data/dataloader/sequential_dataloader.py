...
class SequentialDataLoader(AbstractDataLoader):
    ...
    def _get_processed_data(self, index):
        ...
        elif self.config['SSL_AUG'] == 'MyModel' and self.phase == 'train':
    ...
    def myrec_aug(self, cur_data):
        ...
        cur_data.update(Interaction({'aug_item_1': torch.stack(aug_seq_r), 'aug_item_length_1': torch.stack(aug_len_r)}))
